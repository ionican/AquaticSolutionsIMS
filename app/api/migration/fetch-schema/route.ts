...
export async function GET() {
  try {
    ...
    for (const tableName of MIGRATION_TABLES) {
      // Get column information - table name is from our controlled whitelist so safe to interpolate
      ...
      // Generate PostgreSQL CREATE TABLE statement (excluding audit columns)
      ...
      // Find primary key (usually the identity column or first column)
